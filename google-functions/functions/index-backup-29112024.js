...
const accountSid    = 'AC356fe039b487f2540aa07e44c8f88e7f';
//const SMSFROMNUMBER = '+447830361437';
const SMSFROMNUMBER = 'whatsapp:+14155238886';
//const authToken = 'a2a3912aa39be66bd9d5aae5930bc9fe';
...
const XERO_PLAN_NAME_TEST   = "Test";
...
async function test() {
    ...
    */
    ...
    var results = await xero_pm_create_client_document(customer.access_token, xero.tenant_id, data);
    console.log("📘: results", results);
    return;
    */
    ...
    // PRACTICE MANAGER : Get custom fields
    ...
    data.RFA_AML_Status = "Status";
    data.RFA_AML_Result = "Result";
    data.RFA_AML_Type = "Type";
    data.RFA_AML_URL = "url";
    data.RFA_AML_Dob = "19700403"; // YYYYMMDD
    data.RFA_AML_Title = "Mr";
    data.RFA_AML_Gender = "MALE";
    data.RFA_AML_Middle_Name = "Sudesh";
    data.RFA_AML_Date_Residence = "20150701";
    ...
    */
    ...
    var data = await xero_pm_get_contacts(customer.access_token, xero.tenant_id);
    ...
    */
    ...
    var url = "https://europe-west1-redflag-live.cloudfunctions.net/XERO_update_credits?tenantid=" + tenantid + "&api_key=" + RFA_API_KEY + "&creditlimit=" + creditlimit + "&creditcounter=" + creditcounter;
    ...
    */
    ...
    // "ShortCode": "!!wCRC",
    // https://go.xero.com/organisationlogin/default.aspx?shortcode=!!wCRC&redirecturl=/Contacts/View/699f0091-b127-4796-9f15-41a2f42abeb2
...
/*
exports.XERO_create_user = functions.runWith(runtimeOpts128).region('europe-west1').https.onRequest(async (req, res) => {
    var params = {};
    params.username = req.query.username;
    params.password = req.query.password;
    params.displayname = req.query.displayname;
...
function xero_pm_create_client_document(ip_access_token, ip_tenant_id, ip_data) {
    ...
    return new Promise((resolve, reject) => {
        ...
        var url = XERO_PM_API_URL + "client.api/document";
...
exports.XERO_pm_get_contacts = functions.runWith(runtimeOpts128).region('europe-west1').https.onRequest(async (req, res) => {
    ...
    if (req.method === 'OPTIONS') res.status(204).send('');
        ...
        results = {};
        var contactresults = await xero_pm_get_contacts(access_token, tenant_id);
        results.status = "SUCCESS";
...
/****************************************************************************************************************************************************************/
 ...
 /*
    ...
    console.log("📘: body.firstEventSequence", body.firstEventSequence);
    console.log("📘: body.entropy", body.entropy);

    console.log("📘: Body: "+req.body.toString())
    console.log("📘: Xero Signature: "+req.headers['x-xero-signature'])

    // Your webhook key (replace with your actual key)
