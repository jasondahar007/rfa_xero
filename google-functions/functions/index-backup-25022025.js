...
const RFA_CREATE_USER_URL = "https://account-dev.redflagalert.net/api/external-create-user/"; // TBC 
...
//XERO_aml_new_request                  RFA
//XERO_aml_update_request               RFA
//XERO_aml_resend_request               RFA

//XERO_pm_aml_getdocument               Xero, RFA
//XERO_aml_getdocument                  Xero, RFA
//XERO_oauth                            Firebase, Xero, RFA
...
async function test() {
    ...
    var id_token = 'eyJhbGciOiJSUzI1NiIsImtpZCI6IjFDQUY4RTY2NzcyRDZEQzAyOEQ2NzI2RkQwMjYxNTgxNTcwRUZDMTkiLCJ0eXAiOiJKV1QiLCJ4NXQiOiJISy1PWm5jdGJjQW8xbkp2MENZVmdWY09fQmsifQ..iaarY0INy_vFKh6A4HvnNhGyBIbSr_J8PLmQJO-O9TKQSfo5nkM3p2DnsGP0ysVvlOERoc6ClLkhrjbiyhHKmKlrGsi7DmDW5iIj-pIZCD4a6o9B65umkeijpvjgN-hAAjLH82Rqcd6cEtiTJvMNXTcFz6vsByI5oVq9bu-yg7BW2H9YhgiuC4D3LGMAVbdGZE4Z4gKdUq9XoCw1_oEsMige33ZIm2DqzgWUmh6TViUXnt0XZt2mTb9MYAWRN-dswncsVlRyJXzBH39Y7LPGWrwLBop_DCv8fHftnvrOCttUeUeB9BH4mb__GuW2sQM8H5EqA99EnlVc3l9EJGP8_g';
    var id_token = "eyJhbGciOiJSUzI1NiIsImtpZCI6IjFDQUY4RTY2NzcyRDZEQzAyOEQ2NzI2RkQwMjYxNTgxNTcwRUZDMTkiLCJ0eXAiOiJKV1QiLCJ4NXQiOiJISy1PWm5jdGJjQW8xbkp2MENZVmdWY09fQmsifQ..qP8F98nAcYMjyH0_HX7BunavNRoSgdO12C11xt8rSJo8JipTm981AuV1gzqt979JUpGWmSytCqPFIUFiqUK7TrBtnRDnRNoqSmp8183hTdW97lXdQW_sbBuKrHzFv5LXVVPXpVs_E6vPrUShNBM3bS1wna2OoxIsQ7cE95AQhpsyR_tjfRvZi9kfAczka1t0yMdSEEneZur4ZmeguitfFx7e_2dgjcjsBMgWelh2NieqV6cflMrGQwP2Ce7rpLcQYiWKx73bENw-H8JzpmOHkMove5FcbtooVksrae4WEavGOfgT8L0LqC2THAtO_WTXkVic4WD5YLpQIk0uDHgjAw";
    var id_token = "eyJhbGciOiJSUzI1NiIsImtpZCI6IjFDQUY4RTY2NzcyRDZEQzAyOEQ2NzI2RkQwMjYxNTgxNTcwRUZDMTkiLCJ0eXAiOiJKV1QiLCJ4NXQiOiJISy1PWm5jdGJjQW8xbkp2MENZVmdWY09fQmsifQ..NoKErZ5C5K73UN6RKkCwBYtiPmpKGQlqWRRw3lsoHwC3utRkFpJFZ2Plq2AhvYqzeGOxvkIFFhjwjoOPXOCWVp1ME8MzULWc4vrOrV7ddoLOZ80smq6-OnSGIhicy4HpSwV4CO84K3vmOhEh388mqatJsGMmhPIICW3g5VGE4CFZ6c2eAMZmq9Qeh6qOTU5Fs5FNl1Jod3srJpHbpvPXiuRe0yDi-lKnMT5PlqWj0IR8OBW7jwUQjmXpe5u2vlgDyAI_CMqZtkbeKGFIwISigRaXewBtvvW5pWqEmQhJVeqDSv1pNno4V9xj-ZQartfI3I7toBuvr6trJmydxFWhMg";
    ...
    userdetails.lastname = decoded.family_name;
    ...
    var customer = {};
    customer.tenantid = "a221dd5e-2bdf-4fd3-b56a-6beae564150e"; // Red Flag Alert IDV & AML - PM
    //customer.tenantid = "034e1fc1-9a44-43ef-b0ee-7b4213f138bc"; // RFA Practice
    //customer.tenantid = "cd5f6c0e-f16d-455d-b1ae-dab17f9fea53"; // Deomp Company (UK)
    //customer.tenantid = "f01cc07a-c533-465c-bef2-25490b1dd672";
    ...
    xero.tenant_id     = customer.tenantid;
    xero.refresh_token = "IIpSGZpQ86SSnfFhlPP6URXTpJeVbN5oa21ij6iyaW4";
    //xero.refresh_token = "7CD3e8w3xfIzzGuTFsZ-jZoVyZhYf4AJEFH3A0XBEyI";
    //xero.refresh_token = "Yb0Qci4FpD9llZKqp-0qhC7f7JnMO-jH5ALSVIc30jM";

    //xero.refresh_token = "KWLPiaRNAAV6GBEEvncvg7G3OaZcMVxbWwL0pFBIyHs";
       
    var xeroresults = await xero_getaccesstoken(xero);
    if (xeroresults.status == "ERROR") {
        console.error("📕: ERROR: xero_getaccesstoken", xero);
    }
    console.log("✅ Xero access token", xeroresults.access_token);
    ...
    var staffresults = await xero_pm_get_staff(xeroresults.access_token, customer.tenantid);
    console.log(staffresults);

    email = staffresults.data[0].email;
...
function aml_get_accesstoken(ip_username, ip_password, ip_dev) {
    ...
    return new Promise(resolve => {
        ...
        */
        ...
        if (ip_dev) url = RFA_GRAPHQL_URL_DEV;
        console.log("📘: url", url);                           
...
exports.XERO_oauth_standard = functions.runWith(runtimeOpts128).region('europe-west1').https.onRequest(async (req, res) => {

    console.log("📗📗📗: START Updated - 25/02/2025 :📗📗📗");

    const auth_code = req.query.code;
    console.log("📘: auth_code", auth_code);   

    const user_uid = req.query.state; // State contains the user uid.
    var xero_type = "STANDARD";
    ...
    if (req.method === 'OPTIONS') res.status(204).send('');
        ...
        if (results.status == "SUCCESS") {
            ...
            customer.tenanttype       = 'ORGANISATION';
            ...
            var status = '<div style="display: flex; justify-content: center; align-items: center; height: 100vh; text-align: center; flex-direction: column;">' +
                    '<p style="font-size: 20px;">Red Flag Alert - Xero App has been Installed Successfully.<br><br>For any support, please contact us at:<br><br>' +
            ...
            if (userresults.username) {
                ...
                if (userresults.rfa_user_created == "yes") {      
                    ...
                    if (rfaresults.status == "SUCCESS") {
                        ...
                        console.log("📕: ERROR: rfa_create_user");    
                        // Email: Error
                        var failsubject = "Xero App NEW Installation - STANDARD " + customer.tenantname + " ERROR Creating RFA user";
                        var failemailmessage = '<p style="font-size: 16px;">customer.firstname: <strong>' + customer.firstname + '</strong></p>' +
            ...
            if (xero_account == "NODATA")	{
                ...
                firebase_update_xero_user(user_uid, customer.tenantid, rfa_user_created);
                ...
                admin.database().ref(XERO_FB_TABLE + "/" + customer.tenantid).update({
                    ...
                    xero_disconnect_date : ""             

                });
                firebase_update_xero_user(user_uid, customer.tenantid, rfa_user_created);

                // Build email
                var subject = "Xero App UPDATE STANDARD Installation COMPLETED - " + customer.tenantname;
            ...
            var subject = "Xero App NEW STANDARD Installation FAILED ";
            var status =  "<p style='font-size:20px;text-align:center;'><br><br><br>RedFlag Alert - Xero App Installation FAILED.<br><br>" + "For any support please contact us on<br><br>0330 460 9877<br><br>or<br><br>email: <a href='mailto:helpdesk@redflagalert.com'>helpdesk@redflagalert.com" + "<br><br><a href='https://www.xero.com/uk/'>Xero</a></p>";                        
        }
...
exports.XERO_oauth = functions.runWith(runtimeOpts128).region('europe-west1').https.onRequest(async (req, res) => {
    ...
    console.log("📘: xero_type", xero_type, "user_uid (state)", user_uid);   

    var rfa_user_created = "no"; // 14/02/2025
    ...
    if (req.method === 'OPTIONS') res.status(204).send('');
        ...
        if (results.status == "SUCCESS") {
            ...
            /*
            if (user_uid == "openid") {
                console.log("📘: MODE : openid");   
                var staffresults = await xero_pm_get_staff(customer.access_token, customer.tenantid);
                console.log("📘: staffresults", staffresults);  
                if (staffresults.status == "SUCCESS") {
                    var email = staffresults.data[0].email;
                    var firstname = staffresults.data[0].firstname;
                    var lastname = staffresults.data[0].lastname;
                    var html = '<div style="display: flex; justify-content: center; align-items: center; height: 100vh; text-align: center; flex-direction: column;">' +
                    '<p style="font-size: 20px;">Practice Manager user details retrieved successfully.</p><br>' +
                    '<a href="https://rfa-xero-aml-791aa.web.app/?api=Ju41sjvJbSFVb9c7tFqbRoCczA6WgrSyhuJfaCQ7TOUKXY04IGHcyCHKVnHyaT7o&tenantId=openid&firstname=' + firstname + '&lastname=' + lastname + '&email=' + email + '" target="_blank" style="display: inline-block; padding: 10px 20px; font-size: 16px; text-align: center; text-decoration: none; color: #FFFFFF; background-color: #007BFF; border: none; border-radius: 5px; cursor: pointer;">Return to Sign Up</a></div>';
                }
                else {
                    console.log("📕: ERROR xero_pm_get_staff");
                    var html = '<div style="display: flex; justify-content: center; align-items: center; height: 100vh; text-align: center; flex-direction: column;">' +
                    '<p style="font-size: 20px;">Failed to retrieve Practice Manager user details</p><br>' +
                    '<a href="https://rfa-xero-aml-791aa.web.app" target="_blank" style="display: inline-block; padding: 10px 20px; font-size: 16px; text-align: center; text-decoration: none; color: #FFFFFF; background-color: #007BFF; border: none; border-radius: 5px; cursor: pointer;">Return to Sign In</a></div>';
                }
                console.log("📗📗📗: openid FINISHED :📗📗📗");
                res.status(200).send(html);   
                return;
            ...
            */
                ...
                if (userresults.username) {
                    ...
                    //if (userresults.tenantid) {
                        ...
                        if (rfaresults.status == "SUCCESS") {
                            ...
                            // Email: Error
                            var failsubject = "Xero App NEW Installation - PRACTICE MANAGER " + customer.tenantname + " ERROR Creating RFA user";
                            var failemailmessage = '<p style="font-size: 16px;">customer.firstname: <strong>' + customer.firstname + '</strong></p>' +
                                '<p style="font-size: 16px;">customer.lastname: <strong>' + customer.lastname + '</strong></p>' + '<p style="font-size: 16px;">customer.email: <strong>' + customer.email + '</strong></p>';
                            email_send(failsubject, failemailmessage);                                
            ...
            if (xero_account == "NODATA")	{
                ...
                if (xero_type == "PRACTICEMANAGER") firebase_update_xero_user(user_uid, customer.tenantid, rfa_user_created);
