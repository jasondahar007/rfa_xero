...
//const { PDFDocument, rgb } = require('pdf-lib'); // 06/12/2024
...
async function test() {
    ...
    xero.tenant_id = "f01cc07a-c533-465c-bef2-25490b1dd672";
    ...
    customer.tenantid = xero.tenant_id;
    customer.shortcode = "";
    ...
    console.log("📘: shortcode", customer);
    return;
    
    var short_code = "!kQV5!";


    url = "https://apps.xero.com/!kQV5!/uk/my-apps/e6f66245-37b1-4354-89a6-3943b59f7b99"

    var url = XERO_URL + gv_xero_account.short_code + "/uk/my-apps/" + XERO_APP;
    ...
    var request = {};
    //request.requestid    = "78605"; 
    //request.requestid    = "83690";
    request.requestid    = "87618";

    //request.requestid    = "87148"; // Works
    ...
    request.filename     = "jason-dahar-request-87618.pdf";
    ...
    //var customresults = await xero_pm_get_contact_custom_fields(customer.access_token, xero.tenant_id, "55ee5017-2864-4a32-ad54-92e5b7587a10");
    //console.log(customresults);
    //return;

    //UUID: '3fe496d8-dd3d-435c-983f-48d472882808',
    //Name: 'Lambert',
    //Mobile: '',
    //Email: '',
    //Phone: '',
    ...
    */
    ...
    var access_token = xero.access_token;
    var tenant_id = xero.tenant_id;
...
function xero_pm_get_contacts(ip_access_token, ip_tenant_id) {
    ...
    return new Promise((resolve, reject) => {
        const options = {
            method  : 'GET', 
            url     : XERO_PM_API_URL + "client.api/contacts?pageSize=500",
            headers : { 'Content-Type' : 'application/json', 'Authorization' : `Bearer ${ip_access_token}`, 'Xero-tenant-id' : ip_tenant_id }
        };
        request(options, (error, response, body) => {
            var results = {};
...
async function xero_pm_create_attachment(ip_tenant_id, ip_access_token, ip_contact_id, ip_filelocation, ip_filename) {
    try {
        console.log("📘: Input Parameters:", { ip_tenant_id, ip_access_token, ip_contact_id, ip_filelocation, ip_filename });
        ...
        if (results.status == "SUCCESS") {
            ...
            if (customer.tenanttype == 'ORGANISATION') {
                ...
                if (results.status == "SUCCESS") {
                    ...
                    console.log("📕: ERROR xero_get_user", customer.tenantid);
                }
            ...
            */
            ...
            if (xero_account == "NODATA")	{
                ...
                if (xero_type == "PRACTICEMANAGER") {
                    ...
                    gf_update_xero_user(user_uid, customer.tenantid); // 28/11/2024
